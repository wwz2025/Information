					...
					<view class="rf-pro-content">
						...
						<view v-if="item">
							<view class="rf-pro-price">
								...
								<!-- <view class="rf-sale-price" style="width: 110%;"  :class="'text-'+themeColor.name">
																{{ moneySymbol}}{{item.priceLadder}}</view> -->
								<!-- <text class="rf-sale-price" :class="'text-'+themeColor.name">{{ moneySymbol }}{{ item.priceLadder }}</text>
								 --> 
