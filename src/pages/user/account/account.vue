<template>
	<view class="my-account">
		...
		<view class="header" :class="'bg-' + themeColor.name">
			<view class="account">
				<view class="assets">
					<view>总资产(元)</view>
					<view class="money">
						{{(userInfo && userInfo.allPredeposit ) ||'0.00'}}
					</view>
				</view>
				<text  @tap="navTo('/pages/user/account/recharge')" class="recharge" :class="'text-' + themeColor.name"
					>充值</text
				>
			</view>
			<view class="cumulative">
				...
				<view class="item">
					<view>累计消费(元)</view>
					<view class="money">
						{{-(userInfo&&userInfo.consumptionAmount)||'0.00'}}
					</view>
				</view>
			</view>
		</view>
		...
		<!--广告-->
		<view class="advert">
			<view class="item on" @tap="navTo('/pages/user/coupon/list?storeId=0')">
